...
def fetch_reviews(review_object_id: Optional[str] = None, page_size: int = 100) -> List[Dict]:
    ...
    Args:
        review_object_id: ID конкретного банка или None для всех банков
        page_size: Количество отзывов на страницу (макс. около 100-500, тестируйте)
    
    Returns:
        List[Dict]: Список всех элементов отзывов
    """
    ...
    while True:
        ...
        for item in items:
            ...
            item["bank_name"] = BANK_MAPPING.get(obj_id, None)
