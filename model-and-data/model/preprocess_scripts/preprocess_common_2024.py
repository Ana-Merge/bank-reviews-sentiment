...
def balance_by_category(reviews, max_reviews_per_category=50000):
...
def main():
    ...
    input_file = 'data/generated/2024/generated_multi_label_reviews.jsonl'
    output_dir = 'data/generated/2024/processed'
    output_file = os.path.join(output_dir, 'processed_multi_label_reviews.jsonl')
