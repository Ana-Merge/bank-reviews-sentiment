...
def fetch_reviews(review_object_id: Optional[str] = None, page_size: int = 25000) -> List[Dict]:
    """
    ...
    while True:
        params = {
            ...
            "fingerPrint": "b43cf2076ffe330eadb7902007ae7038"  # Из примера, может потребовать обновления
        }
        if review_object_id:
